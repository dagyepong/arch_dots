...
# Compatible with any live ISO (no special pacstrap flags).
#
...
# Install base system (pacstrap) – minimal flags for compatibility
pacstrap /mnt - <regular_packages_to_install
